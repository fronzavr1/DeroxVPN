...
print("=== TEST: Импортируем expiration_check ===", flush=True)
from handlers.user.expiration_check import check_subscriptions, check_expired_subscriptions
print("=== TEST: expiration_check импортирован ===", flush=True)
